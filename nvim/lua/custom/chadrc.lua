...
local config = require "custom.plugins.config"
...
M.plugins = {
   ...
   default_plugin_config_replace = {
      nvim_treesitter = config.treesitter,
      nvim_tree = config.nvimtree,
   },
...
M.mappings = {
   ...
   misc = {
      ...
      copy_to_system_clipboard = "cp", -- copy selected text (visual mode) or curent line (normal)
